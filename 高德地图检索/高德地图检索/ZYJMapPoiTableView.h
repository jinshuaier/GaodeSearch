...
@protocol ZYJMapPoiTableViewDelegate <NSObject>
...
@interface ZYJMapPoiTableView : UIView <UITableViewDelegate,UITableViewDataSource,AMapSearchDelegate>

@property (nonatomic, weak) id<ZYJMapPoiTableViewDelegate> delegate;
// 选中的POI点
